...
<h1 className={styles.promo_title}>Solicitud de sucursales.</h1>

{solR.length === 0 ? (
        <Alert sx={{ margin: '10px' }} variant='outlined' color='secondary'>
          <p className={styles.promo_title}>
            {`No hay peticiones de sucursales...`}
          </p>
        </Alert>
      ) : (
        <>
...
<h1 className={styles.promo_title}>Solicitud de productos.</h1>

{solR.length === 0 ? (
        <Alert sx={{ margin: '10px' }} variant='outlined' color='secondary'>
          <p className={styles.promo_title}>
            {`No hay peticiones de productos...`}
          </p>
        </Alert>
      ) : (
        <>
