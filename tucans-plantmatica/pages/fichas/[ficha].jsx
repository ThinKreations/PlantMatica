...

                    {
                        ficha.comentarios.map(com=>{
                            ...
                            return (
                                ...
                                <p key={com._id} className={styles.com_Info}>Por: <b>{com.id_usuario.username}</b>, el {Date.parse(com.fecha.dia)}/{Date.parse(com.fecha.mes)}/{Date.parse(com.fecha.year)} </p>
