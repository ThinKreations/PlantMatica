            ...
            <Card>
              <CardContent>
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <p className={styles.text_danger}>
                        Marca esta casilla si el consumo de esta planta puede
                        llegar a ser nocivo o dañino para la salud. De igual
                        manera si su consumo es ilicito en algunas regiones.
                      </p>
                    }
                  />
                </FormGroup>
                ...
                <textarea
                  ...
                  placeholder={
                    'Digite caracteristicas fisicas de la planta (tallos, hojas, semillas), medidas promedio de la planta, mas de lugares de origen y distribucion, habitat y clima de cuidado.'
                  }
                ></textarea>
                ...
                >{`Caracteristicas especiales (Si es aromatica, etc.): `}</p>
                <Autocomplete
                  multiple
                  onChange={(event, caracteristica) =>
                    setCaracteristicas(caracteristica)
                  }
                  id='tags-filled'
                  options={defaultOptions.caracteristicas.map(
                ...
                <textarea
                  ...
                  required
                  className={styles.txtBody}
                  placeholder='Digite al farmaco que puede complementar (Paracetamol, etc). '
                ></textarea>
                <hr className={styles.division} />
                <p
                  className={styles.textD}
                >{`Usos (Medicinales tiene, que malestares puede aliviar (dolores estomacales, enfermedades respiratorias):`}</p>
                <br />
              ...
              <CardActions>
                <button type='submit' className={styles.btnLinkFicha}>
                  Enviar
                </button>
